class MatchedForNotification
  ...
  #   - Have a superset of the keys in the specified query_field for subscriber_lists and and_joined_facet_subscriber_lists
...
private
  ...
  # Returns:
  #
  # all SubscriberLists and AndJoinedFacetSubscriberLists which have a subset of keys from those requested.
  ...
  def only_contains_keys(keys)
    ...
    @scope
      .where(type: ["AndJoinedFacetSubscriberList", nil])
