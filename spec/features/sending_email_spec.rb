RSpec.describe "Sending an email", type: :request do
  ...
  scenario "sending an email for a subscription to an and_joined_facet_subscriber_list" do
  ...
  scenario "sending an email for a subscription to an or_joined_facet_subscriber_list" do
    ...
    and_joined_subscriber_list_id = create_and_joined_facet_subscriber_list(facets.merge(title: "And joined list"))
